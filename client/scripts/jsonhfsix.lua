...
if blockData == nil then
	print(json.encode({error = 'no block data specified'}, {indent = true}))
	return
end

result = Command:new{cmd = cmds.CMD_MIFARE_WRITEBL, arg1 = blockNo ,arg2 = 0,arg3 = 0, data = keyA..'00000000'..blockData}
